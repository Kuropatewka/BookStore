...
public class BookServiceImpl implements IBookService {
    ...
    public List<Book> findBooks(String pattern) {
        Set<Book> result = new HashSet<Book>(); // w setach nie mamy duplikatów dlatego zmienilismy to na seta
        ...
        for(Author author : authors) { // chcemy otrzymac liste autorow bo on moze miec wiecej niz jedna ksiazke i dlatego dwie listy
